...
// Namespaced by tenant, and resolved lazily: this module is evaluated
// before the app entry point registers the brand.
...
export async function getOrCreateDeviceId(): Promise<string> {
  ...
  inflight = (async () => {
    ...
    try {
      await SecureStore.setItemAsync(deviceIdKey(), fresh);
    } catch {
