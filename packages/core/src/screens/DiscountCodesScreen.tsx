...
import { typography, borderRadius, SHARED_TOKENS, screenTopPadding } from "../theme/tokens";
import {
  Badge,
  CardWash,
  EmptyState,
...
function formatDiscountValue(
  ...
  // The currency symbol is the customer's, and where it sits in the
  // sentence is the language's -- hence an interpolation rather than a
  ...
  return t("offers.euroOff", { value: formatPrice(value), symbol });
}
      ...
      >
        ...
        <View style={styles.couponTop}>
          ...
          <Text
            ...
            numberOfLines={1}
          >
            {formatDiscountValue(t, code.type, code.value, config.currencySymbol)}
          </Text>
        </View>
            ...
            <GestureDetector gesture={pan}>
              ...
              >
                ...
                <View style={styles.razorBody}>
                  <LinearGradient
                    colors={[
                      theme.razorSteelLight,
                      theme.razorSteelDark,
                    ]}
                    start={{ x: 0.5, y: 0 }}
                    end={{ x: 0.5, y: 1 }}
